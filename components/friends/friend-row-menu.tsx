  ...
  return (
    ...
    >
      <button
        ...
        className="proof-pill proof-focus grid h-11 w-11 sm:h-7 sm:w-7 place-items-center text-white/50 hover:text-white/85"
      >
      ...
      {open && (
        <div className="absolute right-0 top-12 sm:top-8 z-20 w-36 overflow-hidden rounded-xl border border-white/[0.09] bg-[#0d110f] shadow-proof-card">
          <button
            ...
            className="flex min-h-11 w-full items-center gap-2 px-3 py-2 text-left text-xs font-semibold text-proof-red hover:bg-proof-red/10"
          >
            <UserX size={12} /> {label}
          </button>
        </div>
